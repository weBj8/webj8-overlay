...
CACHY_OS_KERNEL_PATCHES_COMMIT_HASH="bb125fe9a7b8c0a0b67a8a931fc561ffe87f6085"
CACHY_OS_PKGBUILD_COMMIT_HASH="66c0be0ff63fbc7ffa16333e9c364055afef44b7"
...
src_prepare() {
	...
	if use aufs; then
		eapply "${CACHY_OS_PATCHES_DIR}/misc/0001-aufs-6.5-merge-v20230911.patch"
	fi
