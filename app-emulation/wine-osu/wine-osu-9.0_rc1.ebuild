...
PATCHES=(
	"${FILESDIR}"/wine-staging-7.17-noexecstack.patch
	"${FILESDIR}"/wine-staging-7.20-unwind.patch
	"${FILESDIR}"/wine-staging-8.13-rpath.patch
)
...
src_prepare() {
	...
	edo "${PYTHON}" ../wine-staging-9.0-rc1/staging/patchinstall.py "${patchinstallargs[@]}"
