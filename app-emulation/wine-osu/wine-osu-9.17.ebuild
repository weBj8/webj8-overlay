...
WINE_P=wine-${_PV}
_P=wine-staging-${PV}
STAGING_COMMIT="b6944be8105b3307765793ced0e64a646eeae8d1"
WINE_COMMIT="03d985369dc9afe943ee3072478a2567b3fe4077"
...
if [[ ${PV} == *9999 ]]; then
	...
	SRC_URI="
        ...
        https://github.com/whrvt/wine-osu-patches/archive/refs/tags/09-17-2024-03d98536-b6944be8.tar.gz -> ${P}-patch.tar.gz"
	KEYWORDS="-* ~amd64 ~x86"
fi
...
src_unpack() {
    ...
    # WE LUV WAYLAND
    rm "./wine-osu-patches-09-17-2024-03d98536-b6944be8/9000-misc-additions/cursor-clip-hack.patch" || die
    # WE LUV GECKO (WHAT?)
	rm "./wine-osu-patches-09-17-2024-03d98536-b6944be8/9000-misc-additions/gecko-mono-skip-default-envvar.patch" || die
    
	# THESE PATCH BROKE THE COMPILER
	# HOW IT CRASH?
	rm "./wine-osu-patches-09-17-2024-03d98536-b6944be8/0007-proton-fsync/0002-ntdll-loader-add-support-for-overriding-IMAGE_FILE_L.patch" || die
	rm "./wine-osu-patches-09-17-2024-03d98536-b6944be8/0013-server-optimization/0003-qpc/1001-ntdll-Add-__wine_get_tsc_calibration-internal-functi.patch" || die
	rm "./wine-osu-patches-09-17-2024-03d98536-b6944be8/9000-misc-additions/win32u-gdi32-Semi-stub-NtGdiGetDCDpiScaleValue.patch" || die

 
    for dir in ./wine-osu-patches-09-17-2024-03d98536-b6944be8/**; do
