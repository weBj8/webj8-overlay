...
WINE_P=wine-${_PV}
_P=wine-staging-${PV}
STAGING_COMMIT="54f4c57fd6d8724b72c091c9f714795cd763ba45"
WINE_COMMIT="4dfbf077cf708e4bbffa8e086d78d6652bbd69d8"
OSU_PATCHES_TAGS="11-29-2025-4dfbf077-54f4c57f"
...
src_configure() {
	...
	_extra_native_flags+="-static-libgcc   -mtls-dialect=gnu2 -floop-nest-optimize -fgraphite-identity"
    ...
    _extra_cross_flags+="   -mtls-dialect=gnu2 -fvar-tracking-assignments"
    _extra_crossld_flags+=" -Wl,-O2,--sort-common,--as-needed,--file-alignment=4096"

  	_common_cflags="-O3 -march=native -mtune=native -pipe -mfpmath=sse -fno-strict-aliasing -fwrapv -fno-semantic-interposition \
