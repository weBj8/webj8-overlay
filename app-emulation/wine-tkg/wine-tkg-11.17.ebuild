...
WINE_GECKO=2.47.4
WINE_MONO=11.3.0
DESCRIPTION="Free implementation of Windows(tm) on Unix, with Wine-Staging and TKG patches"
HOMEPAGE="https://github.com/Kron4ek/wine-tkg https://github.com/Kron4ek/Wine-Builds"

# Kron4ek's source tag already includes Wine-Staging and TKG patches.
SRC_URI="https://github.com/Kron4ek/wine-tkg/archive/refs/tags/${PV}.tar.gz -> wine-tkg-staging-${PV}.tar.gz"
S="${WORKDIR}/wine-tkg-${PV}"
